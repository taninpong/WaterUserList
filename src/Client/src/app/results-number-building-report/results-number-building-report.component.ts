...
@Component({
  selector: 'app-results-number-building-report',
  templateUrl: './results-number-building-report.component.html',
  styleUrls: ['./results-number-building-report.component.css']
})
export class ResultsNumberBuildingReportComponent implements OnInit {
  reg_list = [];
  cwt_list = [];
  amp_list = [];
  tam_list = [];
  ...
  createData() {
    ...
    sn1list.forEach(sn1 => {
      ...
      _6 = estimate_build ?  parseInt(estimate_build.Building+"") : 0 ; 
      report._1 = _1; 
      report._2 = _2; 
      report._3 = _3; 
      report._4 = _4; 
  ...
  toJSON() {
    ...
    for (let report of this.data) {
      json.push({
        ...
        'รวม': report._5,
        'จำนวน อาคาร อ้างอิง': report._6,
        'จำนวนอาคารสำรวจได้': report._7
      });
    }
    return json;
  }
  exportToExcel() {
    ...
    XLSX.writeFile(wb, 'จำนวนอาคารแยกตามผู้ให้ข้อมูล.csv');
  }
  groupSN1(){
